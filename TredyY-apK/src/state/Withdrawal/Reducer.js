import {
    ...
    GET_ALL_WITHDRAWAL_REQUEST_REQUEST,
    GET_ALL_WITHDRAWAL_REQUEST_SUCCESS,
    GET_ALL_WITHDRAWAL_REQUEST_FAILURE,
  ...
  const withdrawalReducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case GET_ALL_WITHDRAWAL_REQUEST_REQUEST:
      ...
      case GET_ALL_WITHDRAWAL_REQUEST_SUCCESS:
        return {
          ...state,
      ...
      case GET_ALL_WITHDRAWAL_REQUEST_FAILURE:
